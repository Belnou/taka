...
```{r}
mabase_l_statine %>% select(n, num_ligne_ttt, date_j0_ttt, date_fin_ligne_therapeutique_ttt, presence_statine, date_premiere_statine, rechute_1, date_rechute_1, date_derniere_nouvelle, date_fin_ligne_therapeutique_ttt) %>% mutate()

vars_ <- c("")

vars_d <- c("annee_fin","mois_fin","jour_fin","annee_j0","mois_j0","jour_j0","annee_ps","mois_ps","jour_ps","annee_r","mois_r","jour_s","annee_dn","mois_dn","jour_dn")

mabase_l_statine <- bd_traitement  %>% 
  ...
  separate(date_rechute_1, into = c("annee_r","mois_r","jour_s"), sep = "-") %>%
