...
####
CREATION D'UNE BASE DE DONNEE QUI MERGE TOUTES LES VARIABLES D'INTERET , cette base est une base LARGE, une ligne = un patient <- base_large
```{r echo=FALSE}

var_bd1_large <- bd1 %>% select(
  n,
  contains("compl"),
  contains("gest"),
  contains("rech")
...
var_traitement_large <- bd_traitement %>% select(
  num_ligne_ttt, 
  contains("prednisone"),
  contains("is_"),
  contains("stat"),
...
base_large <- cbind(
  var_bd1_large, 
  var_traitement_large
  )

base_large <- base_large %>% select(-contains("date"), -si_arret_prednisone__m18_ttt)
...
vars_large <- base_large %>% select(-n, -num_ligne_ttt) %>% colnames
...
base_large <- base_large   %>% 
  ...
  filter(num_ligne_ttt!="exclure") %>% 
  unite(xxx, vars_large, sep=" ") %>% 
  spread(num_ligne_ttt, xxx) %>% 
  separate(ligne_1, str_c(vars_large, "_ligne_1", sep=c(""))) %>% 
  separate(ligne_2, str_c(vars_large, "_ligne_2", sep=c(""))) %>%
  separate(ligne_3, str_c(vars_large, "_ligne_3", sep=c(""))) %>% 
  separate(ligne_4, str_c(vars_large, "_ligne_4", sep=c(""))) %>% 
  separate(ligne_5, str_c(vars_large, "_ligne_5", sep=c(""))) 

# On remet en facteur
base_large <- base_large  %>% mutate_at(vars(base_large [,map_dbl(base_large ,~length(table(.)))%in%c("1","2")] %>% colnames), as.factor) 

base_large %>% 
  mutate(presence_complication = factor(case_when(
    complication_1_ligne_1=="1"| complication_2_ligne_1=="1"| complication_1_ligne_2=="1"| complication_2_ligne_2=="1"| complication_1_ligne_3=="1"| complication_2_ligne_3=="1"| complication_1_ligne_4=="1"| complication_2_ligne_4=="1"| complication_1_ligne_5=="1"| complication_2_ligne_1=="1" ~"1",
    TRUE~"0"
  )),
  presence_aspirine = factor(case_when(
    aspirine_j0_ttt_ligne_1=="1"|aspirine_m3_ttt_ligne_1=="1"|aspirine_m6_ttt_ligne_1=="1"|aspirine_m12_ttt_ligne_1=="1"|aspirine_m18_ttt_ligne_1=="1"|aspirine_3_ans_ttt_ligne_1=="1"|
      aspirine_j0_ttt_ligne_2=="1"|aspirine_m3_ttt_ligne_2=="1"|aspirine_m6_ttt_ligne_2=="1"|aspirine_m12_ttt_ligne_2=="1"|aspirine_m18_ttt_ligne_2=="1"|aspirine_3_ans_ttt_ligne_2=="1"|
      aspirine_j0_ttt_ligne_3=="1"|aspirine_m3_ttt_ligne_3=="1"|aspirine_m6_ttt_ligne_3=="1"|aspirine_m12_ttt_ligne_3=="1"|aspirine_m18_ttt_ligne_3=="1"|aspirine_3_ans_ttt_ligne_3=="1"|
      aspirine_j0_ttt_ligne_4=="1"|aspirine_m3_ttt_ligne_4=="1"|aspirine_m6_ttt_ligne_4=="1"|aspirine_m12_ttt_ligne_4=="1"|aspirine_m18_ttt_ligne_4=="1"|aspirine_3_ans_ttt_ligne_4=="1"|
      aspirine_j0_ttt_ligne_5=="1"|aspirine_m3_ttt_ligne_5=="1"|aspirine_m6_ttt_ligne_5=="1"|aspirine_m12_ttt_ligne_5=="1"|aspirine_m18_ttt_ligne_5=="1"|aspirine_3_ans_ttt_ligne_5=="1"|aspirine_end_ttt_ligne_1=="1"|aspirine_end_ttt_ligne_2=="1"|aspirine_end_ttt_ligne_3=="1"|aspirine_end_ttt_ligne_4=="1"|aspirine_end_ttt_ligne_5=="1" ~ "1",
    TRUE ~"0"
  )),
    presence_statine = factor(case_when(
    statine_j0_ttt_ligne_1=="1"|statine_m3_ttt_ligne_1=="1"|statine_m6_ttt_ligne_1=="1"|statine_m12_ttt_ligne_1=="1"|statine_m18_ttt_ligne_1=="1"|statine_3_ans_ttt_ligne_1=="1"|
      statine_j0_ttt_ligne_2=="1"|statine_m3_ttt_ligne_2=="1"|statine_m6_ttt_ligne_2=="1"|statine_m12_ttt_ligne_2=="1"|statine_m18_ttt_ligne_2=="1"|statine_3_ans_ttt_ligne_2=="1"|
      statine_j0_ttt_ligne_3=="1"|statine_m3_ttt_ligne_3=="1"|statine_m6_ttt_ligne_3=="1"|statine_m12_ttt_ligne_3=="1"|statine_m18_ttt_ligne_3=="1"|statine_3_ans_ttt_ligne_3=="1"|
      statine_j0_ttt_ligne_4=="1"|statine_m3_ttt_ligne_4=="1"|statine_m6_ttt_ligne_4=="1"|statine_m12_ttt_ligne_4=="1"|statine_m18_ttt_ligne_4=="1"|statine_3_ans_ttt_ligne_4=="1"|
      statine_j0_ttt_ligne_5=="1"|statine_m3_ttt_ligne_5=="1"|statine_m6_ttt_ligne_5=="1"|statine_m12_ttt_ligne_5=="1"|statine_m18_ttt_ligne_5=="1"|statine_3_ans_ttt_ligne_5=="1"|statine_end_ttt_ligne_1=="1"|statine_end_ttt_ligne_2=="1"|statine_end_ttt_ligne_3=="1"|statine_end_ttt_ligne_4=="1"|statine_end_ttt_ligne_5=="1" ~ "1",
    TRUE ~"0"
  )),
      presence_is = factor(case_when(
    is_j0_ttt_ligne_1=="1"|is_m3_ttt_ligne_1=="1"|is_m6_ttt_ligne_1=="1"|is_m12_ttt_ligne_1=="1"|is_m18_ttt_ligne_1=="1"|is_3_ans_ttt_ligne_1=="1"|
      is_j0_ttt_ligne_2=="1"|is_m3_ttt_ligne_2=="1"|is_m6_ttt_ligne_2=="1"|is_m12_ttt_ligne_2=="1"|is_m18_ttt_ligne_2=="1"|is_3_ans_ttt_ligne_2=="1"|
      is_j0_ttt_ligne_3=="1"|is_m3_ttt_ligne_3=="1"|is_m6_ttt_ligne_3=="1"|is_m12_ttt_ligne_3=="1"|is_m18_ttt_ligne_3=="1"|is_3_ans_ttt_ligne_3=="1"|
      is_j0_ttt_ligne_4=="1"|is_m3_ttt_ligne_4=="1"|is_m6_ttt_ligne_4=="1"|is_m12_ttt_ligne_4=="1"|is_m18_ttt_ligne_4=="1"|is_3_ans_ttt_ligne_4=="1"|
      is_j0_ttt_ligne_5=="1"|is_m3_ttt_ligne_5=="1"|is_m6_ttt_ligne_5=="1"|is_m12_ttt_ligne_5=="1"|is_m18_ttt_ligne_5=="1"|is_3_ans_ttt_ligne_5=="1"|is_end_ttt_ligne_1=="1"|is_end_ttt_ligne_2=="1"|is_end_ttt_ligne_3=="1"|is_end_ttt_ligne_4=="1"|is_end_ttt_ligne_5=="1" ~ "1",
    TRUE ~"0"
  )),
        presence_prednisone = factor(case_when(
    prednisone_j0_ttt_ligne_1=="1"|prednisone_m3_ttt_ligne_1=="1"|prednisone_m6_ttt_ligne_1=="1"|prednisone_m12_ttt_ligne_1=="1"|prednisone_m18_ttt_ligne_1=="1"|prednisone_3_ans_ttt_ligne_1=="1"|
      prednisone_j0_ttt_ligne_2=="1"|prednisone_m3_ttt_ligne_2=="1"|prednisone_m6_ttt_ligne_2=="1"|prednisone_m12_ttt_ligne_2=="1"|prednisone_m18_ttt_ligne_2=="1"|prednisone_3_ans_ttt_ligne_2=="1"|
      prednisone_j0_ttt_ligne_3=="1"|prednisone_m3_ttt_ligne_3=="1"|prednisone_m6_ttt_ligne_3=="1"|prednisone_m12_ttt_ligne_3=="1"|prednisone_m18_ttt_ligne_3=="1"|prednisone_3_ans_ttt_ligne_3=="1"|
      prednisone_j0_ttt_ligne_4=="1"|prednisone_m3_ttt_ligne_4=="1"|prednisone_m6_ttt_ligne_4=="1"|prednisone_m12_ttt_ligne_4=="1"|prednisone_m18_ttt_ligne_4=="1"|prednisone_3_ans_ttt_ligne_4=="1"|
      prednisone_j0_ttt_ligne_5=="1"|prednisone_m3_ttt_ligne_5=="1"|prednisone_m6_ttt_ligne_5=="1"|prednisone_m12_ttt_ligne_5=="1"|prednisone_m18_ttt_ligne_5=="1"|prednisone_3_ans_ttt_ligne_5=="1"|prednisone_end_ttt_ligne_1=="1"|prednisone_end_ttt_ligne_2=="1"|prednisone_end_ttt_ligne_3=="1"|prednisone_end_ttt_ligne_4=="1"|prednisone_end_ttt_ligne_5=="1" ~ "1",
    TRUE ~"0"
  )))
...
base_large %>% select(contains("predn")) %>% colnames
```
